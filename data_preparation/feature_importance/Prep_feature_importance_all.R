...
path_snv_imp <- paste0(path_snv_out, "/", date_today, "feature_importance")
...
path_indel_imp <- paste0(path_indel_out, "/", date_today, "feature_importance")
...
path_fusion_imp <- paste0(path_fusion_out, "/", date_today, "feature_importance")
...
path_combined_imp <- paste0(path_combined_out, "/", date_today, "feature_importance")
