...
randomize_feature <- function(feature, dat){
  ...
  # print(all(dat_rem[,col_ind] == dat[,col_ind]))
  # print(all(dat_rem[,2] == dat[,2]))
...
path_snv_imp <- paste0(path_snv_out, "/", date_today, "_feature_importance_rcc_wo_SD")
...
path_indel_imp <- paste0(path_indel_out, "/", date_today, "_feature_importance_rcc_wo_SD")
...
path_fusion_imp <- paste0(path_fusion_out, "/", date_today, "_feature_importance_rcc_wo_SD")
...
path_combined_imp <- paste0(path_combined_out, "/", date_today, "_feature_importance_rcc_wo_SD")
