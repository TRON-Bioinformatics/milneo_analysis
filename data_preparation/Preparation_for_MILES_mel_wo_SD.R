...
# CHANGES:
#- remove patients with stable disease
...
# export data
write_csv(dat_features_full, paste0(path_snv_out, date_today, "_data_miles_mel_wo_SD.csv"))
...
# export data
write_csv(dat_features_indel_full, paste0(path_indel_out, date_today, "_data_miles_mel_wo_SD.csv"))
...
# export data
write_csv(dat_features_fusions_full, paste0(path_fusion_out, date_today, "_data_miles_mel_wo_SD.csv"))
...
write_csv(combined_full, paste0(path_combined_out, date_today, "_data_miles_mel_wo_SD.csv"))
