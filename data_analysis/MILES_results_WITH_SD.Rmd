...
setwd("/projects/SUMMIT/WP1.2/Literature_Cohorts/data_analysis/code/miles_publication/data_analysis/")
...
if(export_plots){
  f <- paste0(path_plots, date_today, "_performance_with_SD.pdf")
...
if(export_table){
  write_delim(auc_overall, paste0("data_for_publication/",date_today, "_performance_models_with_SD.tsv"), delim = "\t")
}
